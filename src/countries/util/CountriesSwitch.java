	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CountriesPackage.GOVERNOR: {
				...
				if (result == null) result = casePolitician(governor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CountriesPackage.PRESIDENT: {
				...
				if (result == null) result = casePolitician(president);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CountriesPackage.COMMISSIONER: {
				...
				if (result == null) result = casePolitician(commissioner);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CountriesPackage.MAYOR: {
				...
				if (result == null) result = casePolitician(mayor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
