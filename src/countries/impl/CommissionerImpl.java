 ...
 * </p>
 * <ul>
 *   <li>{@link countries.impl.CommissionerImpl#getYearElected <em>Year Elected</em>}</li>
 *   <li>{@link countries.impl.CommissionerImpl#getCongressionalDistrict <em>Congressional District</em>}</li>
 *   <li>{@link countries.impl.CommissionerImpl#isIsIncumbent <em>Is Incumbent</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommissionerImpl extends PoliticianImpl implements Commissioner {
	...
	public void setYearElected(int newYearElected) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CountriesPackage.COMMISSIONER__YEAR_ELECTED, oldYearElected, yearElected));
	}
	...
	public void setCongressionalDistrict(int newCongressionalDistrict) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CountriesPackage.COMMISSIONER__CONGRESSIONAL_DISTRICT, oldCongressionalDistrict, congressionalDistrict));
	}
	...
	public void setIsIncumbent(boolean newIsIncumbent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CountriesPackage.COMMISSIONER__IS_INCUMBENT, oldIsIncumbent, isIncumbent));
	}
