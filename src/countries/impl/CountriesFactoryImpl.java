...
public class CountriesFactoryImpl extends EFactoryImpl implements CountriesFactory {
	...
	public static CountriesFactory init() {
		try {
			CountriesFactory theCountriesFactory = (CountriesFactory)EPackage.Registry.INSTANCE.getEFactory(CountriesPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case CountriesPackage.COUNTRY: return createCountry();
			case CountriesPackage.STATE: return createState();
			case CountriesPackage.COUNTY: return createCounty();
			case CountriesPackage.CITY: return createCity();
			case CountriesPackage.GOVERNOR: return createGovernor();
			case CountriesPackage.PRESIDENT: return createPresident();
			case CountriesPackage.COMMISSIONER: return createCommissioner();
			case CountriesPackage.MAYOR: return createMayor();
			case CountriesPackage.POLITICIAN: return createPolitician();
			default:
